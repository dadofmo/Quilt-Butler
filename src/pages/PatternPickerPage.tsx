  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 50+ patterns + design your own block. No login." />
        ...
        <meta property="og:description" content="Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 50+ patterns + design your own block. No login." />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 50+ patterns + design your own block. No login.",
