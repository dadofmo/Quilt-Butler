  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 30+ patterns, no login required." />
        ...
        <meta property="og:description" content="Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 30+ patterns, no login required." />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Free quilt planner with exact yardage, cutting diagrams, cost estimates, and a fabric visualizer. 30+ patterns, no login required.",
